...
UPDATE DRIVER
SET LeaderID = NULL WHERE EmployeeID = 'EMP004';
...
UPDATE SUPERVISOR SET EmployeeID = 'EMP021' WHERE SupervisorID = 'SV-001';

UPDATE SUPERVISOR SET EmployeeID = 'EMP022' WHERE SupervisorID = 'SV-002';
...
UPDATE ROUTE SET SupervisorID = 'SV-002' WHERE RouteNo = 2;
...
UPDATE BUS_SCHEDULE
SET StartTime = '08:30:00' WHERE ScheduleID = 'SCH-002';
